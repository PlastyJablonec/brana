  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <svg style={{ width: '16px', height: '16px', fill: 'var(--md-on-surface-variant)' }} viewBox="0 0 24 24">
          <path d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M16.2,16.2L11,13V7H12.5V12.2L17,14.9L16.2,16.2Z"/>
        </svg>
        <span style={{ 
          fontSize: '0.875rem', 
      ...
      {/* Kompaktní seznam - jen nejnovější 3 */}
        ...
        {activities.slice(0, 3).map((activity, index) => (
          <div
            ...
            style={{
              ...
              gap: '8px',
              padding: '6px 8px',
              backgroundColor: index === 0 ? 'var(--md-primary-container)' : 'transparent',
              borderRadius: '6px',
